...
@pytest.mark.parametrize(("case_name", "transformers"), [pytest.param("case_1", [ReplaceWithColumnInForLoop()])])
def test_replace_with_column_in_for_loop(case_name, transformers) -> None:
