...
@pytest.mark.parametrize(("case_name", "transformers"), [pytest.param("case_1", [ReplaceWithColumnRenamedInForLoop()])])
def test_replace_with_column_renamed_in_for_loop(case_name, transformers) -> None:
