...
@pytest.mark.parametrize(("case_name", "transformers"), [pytest.param("case_1", [ReplaceMultipleWithColumnCalls()])])
def test_replace_multiple_with_column_calls(case_name, transformers) -> None:
