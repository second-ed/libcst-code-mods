...
@pytest.mark.parametrize(("case_name", "transformers"), [pytest.param("case_1", [AssignmentThenGuardToWalrus()])])
def test_assignment_then_none_guard_to_walrus(case_name, transformers) -> None:
