...
from libcst_code_mods.rules.general.passive.replace_nested_list_comps_with_linear_gen_exps import (
    ReplaceNestedListCompsWithLinearGenExps,
)
...
@pytest.mark.parametrize(
    ("case_name", "transformers"), [pytest.param("case_1", [ReplaceNestedListCompsWithLinearGenExps()])]
)
def test_replace_nested_list_comps_with_linear_gen_exps(case_name, transformers) -> None:
