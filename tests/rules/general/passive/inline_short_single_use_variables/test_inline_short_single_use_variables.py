...
@pytest.mark.parametrize(("case_name", "transformers"), [pytest.param("case_1", [InlineShortSingleUseVariables()])])
def test_inline_short_single_use_variables(case_name, transformers) -> None:
