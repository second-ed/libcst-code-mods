...
@pytest.mark.parametrize(
    ("case_name", "transformers"), [pytest.param("case_1", [ReplaceMultipleFunctionCallsInCompWithWalrus()])]
)
def test_replace_multiple_function_calls_in_comp_with_walrus(case_name, transformers) -> None:
