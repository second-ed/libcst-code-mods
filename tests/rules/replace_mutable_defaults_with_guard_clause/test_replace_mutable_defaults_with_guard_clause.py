...
from libcst_code_mods.rules.replace_mutable_defaults_with_guard_clause import ReplaceMutableDefaultsWithGuardClause
...
@pytest.mark.parametrize(
    ("case_name", "transformers"), [pytest.param("case_1", [ReplaceMutableDefaultsWithGuardClause()])]
)
def test_replace_mutable_defaults_with_guard_clause(case_name, transformers) -> None:
