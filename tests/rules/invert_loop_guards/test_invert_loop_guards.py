...
from libcst_code_mods.rules.invert_loop_guards import InvertLoopGuards
...
@pytest.mark.parametrize(("case_name", "transformers"), [pytest.param("case_1", [InvertLoopGuards()])])
